...
# ==========================================
# 1. PAGE CONFIG & THEME (Restored to your Original)
# ==========================================
...
geolocator = Nominatim(user_agent="bharatheeyam_mobile_v111")
...
def get_full_calculations(jd, lat, lon):
    ...
    # --- SURGICAL MANDI FIX (NIGHT CALCULATION) ---
    ...
    # --- PANCHANGA & DASHA (Restored logic) ---
...
# ==========================================
# 4. APP INTERFACE (Restored exactly to your code)
# ==========================================
